...
{
    class NodeDecompressZlib final : public dp::Node
    {
        static constexpr size_t CHUNK_SIZE = 16384;
    public:
        NodeDecompressZlib() : Node("zziger.data_processor_zlib.nodes.zlib.header",
                                     {
    ...
    {
        ContentRegistry::DataProcessorNode::add<NodeDecompressZlib>("zziger.data_processor_zlib.nodes.decompression", "zziger.data_processor_zlib.nodes.zlib");
    }
}